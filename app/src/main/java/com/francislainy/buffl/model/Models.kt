...
data class Card(var cardId: String, var setId: String, var cardQuestion: String, var cardAnswer: String, var boxNumber: Int, var guessed: Boolean = false, var isFlipped: Boolean = false)
